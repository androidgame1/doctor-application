...
class SaleInvoiceController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $total_given_amount = Helper::givenAmountSaleInvoicePayment(null,null,$request->start_date,$request->end_date);
        $total_remaining_amount = Helper::remainingAmountSaleInvoicePayment(null,null,0,$request->start_date,$request->end_date);
