                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="d-flex no-block align-items-center">
                                        ...
                                        <div class="ml-auto">
                                            <h2 class="counter text-danger">{{$count_canceled_activities}}</h2>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
                                    ...
                                    @foreach($activities as $value)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="@if(auth()->user()->is_administrator){{route('administrator.activity.pdf',$value->id)}}@else javascript:void(0) @endif" data-toggle="tooltip" title="{{__('messages.pdf')}}" target="_blank"> <i class="fa fa-file text-primary m-r-10 icon-datatable"></i> </a>
                                                @if($value->status == '0')
