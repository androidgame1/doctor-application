                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        @if(auth()->user()->is_administrator)
                            ...
                            <li> <a class="waves-effect waves-dark" href="@if(auth()->user()->is_administrator) {{route('administrator.purchase_orders')}} @else javascript:void(0) @endif" aria-expanded="false">
                                <i class="fa fa-file"></i>
                                <span class="hide-menu">{{__('messages.purchase_orders')}}</span></a>
                            </li>
