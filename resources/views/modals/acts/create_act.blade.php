<!-- /.modal -->
<div class="modal fade" id="div-create-new-act" tabindex="-1" role="dialog" aria-labelledby="div-create-new-act-modal">
    <div class="modal-dialog" role="document">
        <form method="post" id="form-create-new-act"
                    action="@if(auth()->user()->is_administrator){{route('administrator.act.store')}} @else javascript:void(0) @endif"
