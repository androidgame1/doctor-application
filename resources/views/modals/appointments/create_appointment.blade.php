    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="div-create-new-appointment-modal">New appointment</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="datetime-local" class="form-control {{$errors->has('start_date')?'form-control-danger':''}}" placeholder="Start date" name="start_date" @if(Route::current()->getName() == 'administrator.calendar' || Route::current()->getName() == 'secretary.calendar') readonly @endif required/>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="label-group">End date<span class="text-danger"> * </span></label>
                                <input type="datetime-local" class="form-control {{$errors->has('end_date')?'form-control-danger':''}}" placeholder="End date" name="end_date" @if(Route::current()->getName() == 'administrator.calendar' || Route::current()->getName() == 'secretary.calendar') readonly @endif required/>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
