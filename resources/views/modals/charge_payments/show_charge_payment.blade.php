<!-- /.modal -->
<div class="modal fade" id="div-show-old-charge-payment" tabindex="-1" role="dialog" aria-labelledby="div-show-old-charge-payment-modal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="div-show-old-charge-payment-modal">{{__('messages.show_charge_payment')}}</h4>
