<!-- /.modal -->
<div class="modal fade" id="div-create-new-charge" tabindex="-1" role="dialog" aria-labelledby="div-create-new-charge-modal">
    <div class="modal-dialog" role="document">
        <form method="post" id="form-create-new-charge"
                    action="@if(auth()->user()->is_administrator){{route('administrator.charge.store')}} @else javascript:void(0) @endif"
                    enctype="multipart/form-data" class="needs-validation" novalidate>
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="div-create-new-charge-modal">{{__('messages.new_charge')}}</h4>
                        ...
                        @if($secretary)
                            <div class="col-md-12 col-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control {{$errors->has('secretary')?'no-valid':''}}"
