<!-- /.modal -->
<div class="modal fade" id="div-show-old-product" tabindex="-1" role="dialog" aria-labelledby="div-show-old-product-modal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="div-show-old-product-modal">{{__('messages.show')}} {{__('messages.product')}}</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            </div>
            <div class="modal-body">
                <table id="table-show-old-product" class="table browser m-t-30 no-border">
                <tbody>
                    <tr>
