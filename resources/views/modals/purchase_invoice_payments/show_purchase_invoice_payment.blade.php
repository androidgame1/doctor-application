<!-- /.modal -->
<div class="modal fade" id="div-show-old-purchase-invoice-payment" tabindex="-1" role="dialog" aria-labelledby="div-show-old-purchase-invoice-payment-modal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="div-show-old-purchase-invoice-payment-modal">{{__('messages.show')}} {{__('messages.purchase_invoice_payment')}}</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            </div>
            <div class="modal-body">
                <table id="table-show-old-purchase-invoice-payment" class="table browser m-t-30 no-border">
                <tbody>
                    <tr>
