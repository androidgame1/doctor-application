                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <select class="form-control {{$errors->has('way_of_payment')?'no-valid':''}}"
                                    ...
                                    <option value="check" {{$purchase_invoice_payment->way_of_payment == 'check' ? 'selected' : ''}}>{{__('messages.check')}}</option>
                                    ...
                                    <option value="others" {{$purchase_invoice_payment->way_of_payment == 'others' ? 'selected' : ''}}>{{__('messages.others')}}</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" value="{{$purchase_invoice_payment->given_amount}}" min="0.1" max="{{$purchase_invoice_payment->remainig_amount_plus_edited_given_amount}}" step="0.01" class="form-control {{$errors->has('given_amount')?'no-valid':''}}" placeholder="{{__('messages.given_amount')}}" name="given_amount" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="label-group">{{__('messages.justification')}}<span class="text-danger d-none"> * </span></label>
                                <input type="file" class="form-control dropify {{$errors->has('justification')?'no-valid':''}}" data-default-file="{{$purchase_invoice_payment->justification ? asset($purchase_invoice_payment->justification) : ''}}" placeholder="{{__('messages.justification')}}" name="justification">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="label-group">{{__('messages.remark')}}<span class="text-danger d-none"> * </span></label>
                                <textarea rows="5" class="form-control {{$errors->has('remark')?'no-valid':''}}" placeholder="{{__('messages.remark')}}" name="remark">{{$purchase_invoice_payment->remark}}</textarea>
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="form-group">
