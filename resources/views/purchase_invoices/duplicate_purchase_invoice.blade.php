...
<div class="row page-titles">
    <div class="col-12 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">{{__('messages.duplicate_purchase_invoice')}}</li>
            </ol>
    </div>
</div>
<!-- ============================================================== -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea rows="4" class="form-control {{$errors->has('remark')?'no-valid':''}}" placeholder="{{__('messages.remark')}}" name="remark">{{$purchase_invoice->remark}}</textarea>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
