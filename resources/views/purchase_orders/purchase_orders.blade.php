                                    ...
                                    @foreach($purchase_orders as $value)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="@if(auth()->user()->is_administrator){{route('administrator.delivery_order.convert_po_to_do',$value->id)}}@else javascript:void(0) @endif" title="{{__('messages.convert')}}"> <i class="fa fa-refresh text-info m-r-10 icon-datatable"></i> </a>
